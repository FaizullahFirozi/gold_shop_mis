        ...
        <div class="row  col-lg-8 offset-2">
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              <!-- title row -->
					<img src="<?= base_url(); ?>assets/images/islamic.jpg" height="100" alt="Gold Picture">
					<img src="<?= base_url(); ?>assets/images/a.jpg" height="100" alt="Gold Picture">
					<img src="<?= base_url(); ?>assets/images/b.png" height="100" alt="Gold Picture">
					<img src="<?= base_url(); ?>assets/images/d.png" height="100" alt="Gold Picture">
					<img src="<?= base_url(); ?>assets/images/islamic.jpg" height="100" alt="Gold Picture">
              <div class="row">
                <div class="col-12">
                  <h4>
...
<hr>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="<?= base_url(); ?>Sales/invoice_print/<?= $row->sale_id; ?>" target="_blank" class="btn btn-danger w-25"><i class="fas fa-print"></i> Print</a>
                </div>
              </div>
            </div>
            <!-- /.invoice -->
